...
code = code.replace(/https:\/\/images\.unsplash\.com\/photo-1753613648137-602c669cbe07\?w=700\&h=500\&fit=crop/g, 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=700&h=500&fit=crop');
...
code = code.replace(/text-slate-600 dark:text-slate-400/g, 'text-slate-300');

code = code.replace('Start Your Journey Today<br />with CTC Club', 'Start Your Tech Journey<br />Today');
