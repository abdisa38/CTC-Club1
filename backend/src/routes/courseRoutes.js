...
router.route('/')
    ...
    .post(authMiddleware_1.protect, (0, authMiddleware_1.authorizeRoles)('instructor', 'admin'), courseController_1.createCourse);
// ID operations: Get singular, Update, Delete
router.route('/:id')
    .get(courseController_1.getCourseById)
    .put(authMiddleware_1.protect, (0, authMiddleware_1.authorizeRoles)('instructor', 'admin'), courseController_1.updateCourse)
